...
(async () => {
  ...
  await fs.writeFile("respiratory-distress-of-newborn-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("respiratory-distress-of-newborn-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
